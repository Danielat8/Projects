<?php
require_once __DIR__ . "/../php/Queries/EditAuthorQuery.php";
            ...
            <div class="row row-cols-3 justify-content-center align-items-center">
                <div class="col-4 mt-4">
                    <div class="mb-3">
                        ...
                        <input value="<?= htmlspecialchars($authors['name'] ?? '') ?>" name="name" type="text" class="form-control" id="name">
                        ...
                        <input value="<?= htmlspecialchars($authors['surname'] ?? '') ?>" name="surname" type="text" class="form-control" id="surname">
                        ...
                        <textarea class="form-control" id="biography" name="biography" style="height: 100px"><?= htmlspecialchars($authors['biography'] ?? '') ?></textarea>
