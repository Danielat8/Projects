<?php
require_once __DIR__ . "/../php/Queries/CreateCategoryQuery.php";
            ...
            <div class="row row-cols-3 justify-content-center align-items-center">
                <div class="col-4 mt-4">
                    <div class="mb-3">
                        ...
                        <input name="category_id" type="text" class="form-control" id="exampleInputTitle" value="<?= htmlspecialchars($category_id ?? '') ?>">
