...
<div class="container " style="margin-bottom: 200px; margin-top:100px;">
    ...
    <form id="edit-blog-form" method="POST" action="{{ route('admin.blogs.update', $blog->id) }}" class="bg-light p-4 shadow rounded">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mb-3">
            ...
            <textarea name="body" id="body" class="form-control" rows="4" placeholder="Blog Description">{{ old('body', $blog->body) }}</textarea>
        </div>
